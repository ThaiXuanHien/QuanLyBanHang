...
public class DienThoaiActivity extends AppCompatActivity {
    ...
    private void loadMoreData() {
        lvDienThoai.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("thongTinSanPham", listDienThoai.get(i));
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongDanDienThoai, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response != null && response.length() != 2) {
                    lvDienThoai.removeFooterView(progressbar);
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            listDienThoai.add(new SanPham(maSP, tenSanPham, gia, hinhAnhSP, moTa, maLoai));
    ...
    private void anhXa() {
        ...
        dienThoaiAdapter = new DienThoaiAdapter(getApplicationContext(), listDienThoai);
    ...
    public class MyHandler extends Handler {
        ...
        public void handleMessage(@NonNull Message msg) {
            switch (msg.what) {
                case 0:
                    lvDienThoai.addFooterView(progressbar);
                    break;
                case 1:
                    getData(++page);
                    isLoading = false;
